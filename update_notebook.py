...
nb_path = "c:/_MananjaraPerso/MASTER/ML/TP_Regression_lineaire.ipynb"
nb = nbf.read(nb_path, as_version=4)

export_code = """import joblib
...
md_text = """### 📌 Partie 4 : Déploiement d’une application Streamlit
...
inst_text = """Vous pouvez ensuite lancer votre application Streamlit dans le terminal avec la commande :
`!streamlit run app.py`"""

nb.cells.append(nbf.v4.new_code_cell(export_code))
nb.cells.append(nbf.v4.new_markdown_cell(md_text))
nb.cells.append(nbf.v4.new_code_cell(app_code))
nb.cells.append(nbf.v4.new_markdown_cell(inst_text))
